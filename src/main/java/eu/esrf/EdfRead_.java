 ...
 *              - support edf-files where first character header is not { (cfr cborel's problem)    *
...
public class EdfRead_ implements PlugIn {

	private static final String EdfRead_VERSION = "December 2005";
